...
namespace Terminal.Gui {
	...
	public class ColorScheme : IEquatable<ColorScheme> {
		...
		public override int GetHashCode ()
		{
			...
			hashCode = hashCode * -1521134295 + (_normal?.GetHashCode () ?? 0);
			hashCode = hashCode * -1521134295 + (_focus?.GetHashCode () ?? 0);
			hashCode = hashCode * -1521134295 + (_hotNormal?.GetHashCode () ?? 0);
			hashCode = hashCode * -1521134295 + (_hotFocus?.GetHashCode () ?? 0);
			hashCode = hashCode * -1521134295 + (_disabled?.GetHashCode () ?? 0);
			return hashCode;
		}
